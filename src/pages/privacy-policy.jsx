            ...
            <div className="about-page">
                ...
                <div className="contentAbout">
                    ...
                    <ul>
                        ...
                        <li><strong>Disclosure for a business purpose:</strong> shared with our processor Shopify, Google, Facebook, Printify.</li>
                    </ul>
                    <p><u>Customer support information</u></p>
                    <ul>
                        <li><strong>Examples of Personal Information collected:</strong>&nbsp;<i>email, phone number, all personal information.</i></li>
                        <li><strong>Purpose of collection:</strong> to provide customer support.</li>
                        <li><strong>Source of collection:</strong> collected from you.</li>
                        <li><strong>Disclosure for a business purpose:</strong>&nbsp;<i>Facebook, Google, SMS, marketing stuff.</i></li>
                    </ul>
                    <p><i>Marketing, upselling.</i></p>
                    <h2>Minors</h2>
                    <p>The Site is not intended for individuals under the age of 12. We do not intentionally collect Personal Information from children. If you are the parent or guardian and believe your child has provided us with Personal Information, please contact us at the address below to request deletion.</p>
                    ...
                    <ul>
                        ...
                        <li><i>Facebook, Google, Instagram, Printify</i></li>
                    </ul>
                    ...
                    <i><i>Last updated: 13 September 2021</i></i>
                    <p>If you are not satisfied with our response to your complaint, you have the right to lodge your complaint with the relevant data protection authority. You can contact your local data protection authority, or our supervisory authority here:&nbsp;<i>hello@islamtshirt.com</i></p>
                </div>
            </div>
        </Layout>
    )
